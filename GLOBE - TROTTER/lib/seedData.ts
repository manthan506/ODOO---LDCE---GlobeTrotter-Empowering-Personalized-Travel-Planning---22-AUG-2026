...
export async function ensureSeedData() {
  ...
  const citiesData = [
    ...
    },
    {
      ...
      description: 'Ultramodern vibrant metropolis seamlessly intertwined with timeless temples.',
    },
    {
      name: 'Bali',
      country: 'Indonesia',
  ...
  const activitiesData = [
    ...
    },
    {
      ...
      duration: 200,
      category: 'food',
      description: 'Zip through Bangkok alleys in vibrant tuk-tuks tasting Michelin-guide pad thai, satay, and mango sticky rice.',
